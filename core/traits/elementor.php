...
trait Elementor {
    ...
    public static function get_current_element() {
        return apply_filters('elementor/mesh3d/current_element', false);
    }
    ...
    public static function get_current_template($post_id = false) {
        ...
        if (\Elementor\Plugin::instance()->db->is_built_with_elementor($post_id)) {
            ...
            if (\Mesh3d\Core\Utils::is_plugin_active('elementor-pro')) {
    ...
    public static function get_extra_css($p_id = false, $theme = false) {
        ...
        //$styles['query'] = MESH_3D_PATH . '/modules/query/assets/css/common-query.css';
        // THEME
        if ($theme) {
